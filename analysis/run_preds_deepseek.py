...
def main():
    parser = argparse.ArgumentParser(description="Generate DeepSeek predictions CSV")
    ...
    out = (
        Path("../output/evaluation/batch/preds_deepseek.csv")
        if args.batch
        else Path("../output/evaluation/preds_deepseek.csv")
    )
