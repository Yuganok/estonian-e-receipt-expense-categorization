...
def main():
    parser = argparse.ArgumentParser(description="Generate Claude predictions CSV")
    ...
    out = (
        Path("../output/evaluation/batch/preds_claude.csv")
        if args.batch
        else Path("../output/evaluation/preds_claude.csv")
    )
